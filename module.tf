resource "azurerm_windows_web_app" "webapp" {
  ...
  app_settings                                   = try(var.appServiceWindows.app_settings, {})
  ...
  ftp_publish_basic_authentication_enabled       = try(var.appServiceWindows.ftp_publish_basic_authentication_enabled, true)
  https_only                                     = try(var.appServiceWindows.https_only, false)
  public_network_access_enabled                  = try(var.appServiceWindows.public_network_access_enabled, false)
  ...
  site_config {
    ...
    ip_restriction_default_action                 = try(var.appServiceWindows.site_config.ip_restriction_default_action, "Deny")
    ...
    scm_ip_restriction_default_action             = try(var.appServiceWindows.site_config.scm_ip_restriction_default_action, "Deny")
  ...
  dynamic "sticky_settings" {
    for_each = try(var.appServiceWindows.sticky_settings, {})
    content {
